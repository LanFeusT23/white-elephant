...
export const EVENT = { name: "Event" }
export const EVENTSLANDING = { name: "EventsLanding" }
export const EVENTCREATE = { name: "EventCreate" }
export const HOME = { name: "Home" }
export const LANDING = { name: "Landing" }
...
export const routerGuard = (to: RouteLocationNormalized, from: RouteLocationNormalized, next: NavigationGuardNext) => {
